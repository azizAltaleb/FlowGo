    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <p className="text-muted-foreground">
              Use this mode when you want ArtificialFlow to provide its own IAM stack with ZITADEL.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ArtificialFlow recognizes these standard IAM roles: {standardRoles.join(", ") || "-"}.
          </CardDescription>
        </CardHeader>
