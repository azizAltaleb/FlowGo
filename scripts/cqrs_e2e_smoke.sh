...
SYNC_GROUP_ID="${SYNC_GROUP_ID:-goflow-sync-worker-v8}"
SYNC_READY_TOPIC="${SYNC_READY_TOPIC:-goflow.public.process}"
SYNC_READY_TOPICS="${SYNC_READY_TOPICS:-workflow.events.v1,goflow.public.process,goflow.public.process_instance,goflow.public.element_instance,goflow.public.variable,goflow.public.job,goflow.public.incident,goflow.public.timer,goflow.public.message_subscription}"
