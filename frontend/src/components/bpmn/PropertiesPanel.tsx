...
export default function PropertiesPanel({ element, onUpdate }: PropertiesPanelProps) {
  ...
  const assignee = (data['@_workflowsa:assignee'] as string) || '';
  const candidateUsers = (data['@_workflowsa:candidateUsers'] as string) || '';
  const candidateGroups = (data['@_workflowsa:candidateGroups'] as string) || '';
  
  // Business Rule Task properties
  const decisionRef = (data['@_workflowsa:decisionRef'] as string) || '';
  const brResultVariable = (data['@_workflowsa:resultVariable'] as string) || '';

  // Service Task properties
  const topic = (data['@_workflowsa:topic'] as string) || '';
  const taskType = (data['@_workflowsa:taskType'] as string) || '';

  // Script Task properties
  const scriptFormat = (data['@_scriptFormat'] as string) || '';
  const scriptResultVariable = (data['@_workflowsa:resultVariable'] as string) || '';
                        ...
                        <div className="space-y-3 pt-2 border-t">
                            ...
                            <div className="space-y-3">
                                <div className="space-y-2">
                                    ...
                                    <DebouncedInput
                                    value={assignee}
                                    onValueChange={(val) => updateField('@_workflowsa:assignee', val)}
                                ...
                                <div className="space-y-2">
                                    ...
                                    onValueChange={(val) => updateField('@_workflowsa:candidateUsers', val)}
                                ...
                                <div className="space-y-2">
                                    ...
                                    onValueChange={(val) => updateField('@_workflowsa:candidateGroups', val)}
                        ...
                        <div className="space-y-3 pt-2 border-t">
                            ...
                            <div className="space-y-3">
                                <div className="space-y-2">
                                    ...
                                    <DebouncedInput
                                    value={decisionRef}
                                    onValueChange={(val) => updateField('@_workflowsa:decisionRef', val)}
                                ...
                                <div className="space-y-2">
                                    ...
                                    onValueChange={(val) => updateField('@_workflowsa:resultVariable', val)}
                        ...
                        <div className="space-y-3 pt-2 border-t">
                            ...
                            <div className="space-y-3">
                                <div className="space-y-2">
                                    ...
                                    <DebouncedInput
                                    value={topic}
                                    onValueChange={(val) => updateField('@_workflowsa:topic', val)}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <DebouncedInput
                                    value={taskType}
                                    onValueChange={(val) => updateField('@_workflowsa:taskType', val)}
