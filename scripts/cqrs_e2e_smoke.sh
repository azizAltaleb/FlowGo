...
SYNC_GROUP_ID="${SYNC_GROUP_ID:-flowgo-sync-worker-v8}"
SYNC_READY_TOPIC="${SYNC_READY_TOPIC:-flowgo.public.process}"
SYNC_READY_TOPICS="${SYNC_READY_TOPICS:-workflow.events.v1,flowgo.public.process,flowgo.public.process_instance,flowgo.public.element_instance,flowgo.public.variable,flowgo.public.job,flowgo.public.incident,flowgo.public.timer,flowgo.public.message_subscription}"
