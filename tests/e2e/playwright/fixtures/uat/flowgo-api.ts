...
export class FlowGoApi {
  ...
  inboxHeaders(actingUser: ActingUser): Record<string, string> {
    return {
      "X-FlowGo-Acting-Subject": actingUser.subject,
      "X-FlowGo-Acting-Username": actingUser.username || "",
      "X-FlowGo-Acting-Email": actingUser.email || "",
      "X-FlowGo-Acting-Name": actingUser.name || "",
      "X-FlowGo-Acting-Roles": actingUser.roles.join(","),
    };
  }
