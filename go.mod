...
require (
	...
	go.opentelemetry.io/auto/sdk v1.2.1 // indirect; force downgrade
	golang.org/x/crypto v0.47.0 // indirect; force downgrade
	golang.org/x/sync v0.18.0 // indirect; force downgrade
	golang.org/x/text v0.33.0 // indirect; force downgrade
