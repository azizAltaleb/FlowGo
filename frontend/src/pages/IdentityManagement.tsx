    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage bundled ZITADEL users and Workflowsa role assignments.</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>This screen is available only in bundled ZITADEL mode for workflowsa admin users.</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-wrap gap-2">
          <Badge>Bundled ZITADEL</Badge>
          <Badge variant="success">workflowsa admin</Badge>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Create a human ZITADEL user and assign Workflowsa roles.</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader><CardTitle>Roles</CardTitle><CardDescription>View, update, and delete Workflowsa project roles.</CardDescription></CardHeader>
